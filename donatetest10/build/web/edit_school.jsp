...
<head>
    ...
    <title>Edit School Supplies Donation</title>
</head>
<body class="body-bg">
    ...
    <%
            ...
            try{
                ...
                ps = con.prepareStatement("select * from school_donate where id="+id+"");
                rs = ps.executeQuery();
                if (rs.next()){
                    ...
                    <div class="col-12 mt-5">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h6 class="header-title" style="text-align: center">Update School Supplies Donation Entry</h6>
