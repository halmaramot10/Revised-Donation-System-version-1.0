    ...
    <!-- main wrapper start -->
        ...
        <div class="main-content-inner">
            <div class="container">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="form-group col-3">
                                    ...
                                    <select class="form-control form-control-sm" id="dropdowns" onchange="tableshow2()">
                ...
                <div class="row" style="display:none" id="itemdrops">
                    <div class="col-12 mt-5">
                        <div class="card">
                            <div class="card-body">
                                <h6>Item Category</h6>
                ...
                <div class="row" style="display:none" id="paydrops">
                    <div class="col-12 mt-5">
                        <div class="card">
                            <div class="card-body">
