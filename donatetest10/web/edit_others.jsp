...
<head>
    ...
    <title>Edit Other Donation</title>
</head>
<body class="body-bg">
    ...
    <%
            int id = 0;
            String date = null, item = null, des = null, qty = null,cond = null,fr = null, donto = null, stat = null;
            String addedby = null, invoicenum = null;
            
            try{
                id = Integer.parseInt(request.getParameter("id"));
                con = DB.getConnection();
                ps = con.prepareStatement("select * from others_donate where id="+id+"");
                rs = ps.executeQuery();
                if (rs.next()){
                    ...
                    <div class="col-12 mt-5">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h6 class="header-title" style="text-align: center">Update Other Donation Entry</h6>
                                <form action="Update_Others" method="post">
                                    <div class="row">
