                    ...
                    <div class="col-12 mt-5">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="Add_Donation_Admin" method="post">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-3" id="item1" style="display:">
                                            ...
                                            <select name="item1" class="form-control form-control-sm" id="item01" onchange="show1()">
                                        ...
                                        <div class="form-group col-3" id="item2" style="display:none">
                                            <label for="item">Item Type</label>
                                            <select name="item2" class="form-control form-control-sm" id="item02" onchange="show1()">
                                                <option>Select One</option>
                                                <%
                                            try{
                                                con=DB.getConnection();
                                        ...
                                        <div class="form-group col-3" id="item3" style="display:none">
                                            <label for="item">Item Type</label>
                                            <select name="item3" class="form-control form-control-sm" id="item03" onchange="show1()">
                                                <option>Select One</option>
                                                <%
                                            try{
                                                con=DB.getConnection();
                                        ...
                                        <div class="form-group col-3" id="item4" style="display:none">
                                            <label for="item">Item Type</label>
                                            <select name="item4" class="form-control form-control-sm" id="item04" onchange="show1()">
                                                <option>Select One</option>
                                                <%
                                            try{
                                                con=DB.getConnection();
                                        ...
                                        <div class="form-group col-3" id="item5" style="display:none">
                                            ...
                                            <select name="item5" class="form-control form-control-sm" id="item05" onchange="show1()">
                                                <option>Select One</option>
                                                <%
                                            try{
                                                con=DB.getConnection();
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-3" onchange = "shows2()" id="qtyform">
                                            ...
                                            <input type="text" id = "qty" name="qty" class="form-control form-control-sm" required="required">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-3" style="display:none" id="expform">
                                            ...
                                            <input type="date" id="example-date-input" name="exp" class="form-control form-control-sm">
                                        </div>
                                    ...
                                    <div class="row" style="display:none" id="moneysss">
                                        ...
                                        <div class="form-group col-4" style="display:none" id="bnkform">
                                            ...
                                            <select id="pay1" name="pay1" class="form-control form-control-sm" onchange="shows3()">
                                                 <%
                                            try{
                                                con=DB.getConnection();
                                        ...
                                        <div class="form-group col-4" style="display:none" id="olform">
                                            ...
                                            <select id="pay2" name="pay2" class="form-control form-control-sm" onchange="shows3()">
                                                <%
                                            try{
                                                con=DB.getConnection();
