...
<head>
    ...
    <title>Edit Food Donation</title>
</head>
<body class="body-bg">
    ...
    %>
        <%
            int id = 0;
            String date = null, item = null, des = null, qty = null,exp = null,fr = null, donto = null, stat = null;
            String addedby = null, invoicenum = null;
            
            try{
                id = Integer.parseInt(request.getParameter("id"));
                con = DB.getConnection();
                ps = con.prepareStatement("select * from foods_donate where id="+id+"");
                rs = ps.executeQuery();
                if (rs.next()){
                                ...
                                <form action="Update_Food" method="post">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-3">
                                            ...
                                            <input type="date" id="example-date-input" name="exp" class="form-control form-control-sm" value="<%=exp%>">
                                        </div>
                                        <!--Constant Forms-->
