...
/*Get value from Donation Types*/
    ...
    if(types.value==="Food"){
        ...
        var item = document.getElementById("item02");
        
        if(item.value === "Add New Item"){
        ...
        var item = document.getElementById("item03");
        ...
        var item = document.getElementById("item05");
        ...
        var item = document.getElementById("item04");
...
function shows3(){
    ...
    if(mt.value==="Bank"){
        ...
        var nb = document.getElementById("pay1");
        if (nb.value === "Add New Bank"){
        ...
        var nb = document.getElementById("pay2");
        if (nb.value === "Add New Application"){
            document.getElementById('nbafrm').style.display= '';
            document.getElementById('metform').className = "form-group col-3";
